...
/**
 * my app code Evenmorevago v1.0
 * Name Pop up js library
 * Description this library fetch records of a campaign and put them as pop ups
 * Author Tier5 LLC (jon@thinkvaughn.com)
 */
var vm = new Vue({
    data: {
        title: 'Initializing...',
    ...
    computed : {
        ...
        /**
         * get the id to call api
         * @returns {string | null | *}
         */
        myApiId: function () {
            this.js_id = document.querySelector('script[data-name="_emv"][data-token]').getAttribute('data-token');
            return this.js_id;
        },
        /**
         * this function returns the url for resources
         * @returns {string|string}
         */
        myResourceUrl: function () {
            if (window.location.host == "localhost" || window.location.host == "127.0.0.1") {
        ...
        /**
         * toggles between opacity value
         * @returns {boolean|*}
         */
        toggleOpacity: function () {
            this.my_opacity = !this.my_opacity;
            this.my_opacity === true ? 1 : 0;
            return this.my_opacity;
        }
    },
    methods: {
        /**
        ...
        getCampaignDetails: function () {
            var unique_id       = this.myApiId;
            var url             = this.myApiUrl;
            var thisInstance    = this;
            axios.get(url+'campaign-details/'+unique_id).then(function (response) {
                if (response.status === 200 && response.statusText === "OK") {
                    thisInstance.checkDomainName(response.data.response);
                } else {
        ...
        /**
         * this function check domain name which is same with the address bar or not
            ...
            if (sticky_reviews.length > 0) {
                ...
                setInterval(function () {
                    ...
                    targetDiv.innerHTML = '<div id="sticky-reviews-rectangular-two" class="animated ">' +
                        ...
                        '<h3>' + vmm.my_reviews[vmm.myIndex].sticky_review_name + '</h3>' +
                        '<h4>' + vmm.my_reviews[vmm.myIndex].memo + '</h4>' +
                        '<h5>' +
                        ...
                        '</div>' +
                        '</div>';
                    // targetDiv.innerHTML = vmm.my_reviews[vmm.arrIndex++].sticky_review_name;
